<template>
	<view>
		...
		<view class="search-view">
			<!-- <picture style="width:35upx;height: 35upx;">
			    <source srcset="../../../static/coen/dingwei.svg"  type="image/svg+xml">
			    <img src="../../../static/coen/dingwei.svg" style="display:block;width:35upx;height:35upx">
			</picture>
			<object type="image/svg+xml"  style="width:35upx;height:35upx" >
			    <param name="src" value="../../../static/coen/dingwei.svg" >
			</object> -->
			<!-- <i class="iconfont">&#xe600;</i> -->
			<!-- <embed style="width: 35upx;height:35upx" src="../../../static/coen/dingwei.svg" /> -->
			<!-- 不支持 -->
		...
		<view class="search-cont">
			<view class="search" @click="seaRch">
				<!-- <embed class="search-img" src="../../../static/coen/sousuo.svg" /> -->
			...
			<block v-for="(item, index) in lable" :key="index">
				<swiper-item>
					<view class="swiper-item">
						<block v-for="listdata in item" :key="listdata.title">
		...
		<view class="instruct-view">
			<block v-for="(item, index) in lable" :key="index">
			<view  :class="{active:index == num}" class="instruct"></view>
			</block>
		</view>
	</view>
</template>
...
/* @font-face {
	  font-family: 'iconfont';  /* project id 2041532 */
/* src: url('//at.alicdn.com/t/font_2041532_vxxb328vg6a.eot');
	  src: url('//at.alicdn.com/t/font_2041532_vxxb328vg6a.eot?#iefix') format('embedded-opentype'),
	  url('//at.alicdn.com/t/font_2041532_vxxb328vg6a.woff2') format('woff2'),
	  url('//at.alicdn.com/t/font_2041532_vxxb328vg6a.woff') format('woff'),
	  url('//at.alicdn.com/t/font_2041532_vxxb328vg6a.ttf') format('truetype'),
	  url('//at.alicdn.com/t/font_2041532_vxxb328vg6a.svg#iconfont') format('svg');
	}
	.iconfont{
